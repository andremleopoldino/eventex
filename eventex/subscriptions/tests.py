...
class SubscribePostTest(TestCase):
    ...
    def test_subscription_email_to(self):
        email = mail.outbox[0]
        expect = ['contato@eventex.com.br' , 'andrem01310@gmail.com']
    ...
    def test_subscription_message(self):
        ...
        self.assertIn('André Leopoldino', email.body)
        self.assertIn('12345678901', email.body)
        self.assertIn('andrem01310@gmail.com', email.body)
        self.assertIn('11-98353-9575', email.body)
